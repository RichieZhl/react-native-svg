...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/richiezhl/react-native-svg.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'

  s.source_files = 'react-native-svg/Classes/**/*'
  
  # s.resource_bundles = {
  #   'react-native-svg' => ['react-native-svg/Assets/*.png']
  # }
